...
const ARENA_BIOME_DEFINITIONS: Record<ArenaBiomeId, ArenaBiomeDefinition> = {
  prismVerge: {
    ...
    glowColor: '#FFAFF4',
    base: '#040812',
    auraA: 'rgba(255, 82, 214, 0.15)',
    auraB: 'rgba(49, 204, 255, 0.12)',
    enemyZone: 'rgba(162, 83, 255, 0.10)',
    boundary: 'rgba(255, 154, 79, 0.38)',
    grid: 'rgba(148, 102, 255, 0.22)',
    overlay: '#170A2A',
    flow: '#34D2FF',
    pulse: '#FF74EA',
  ...
  hiveForge: {
    ...
    glowColor: '#BAFFF6',
    base: '#040F15',
    auraA: 'rgba(86, 255, 225, 0.12)',
    auraB: 'rgba(194, 114, 255, 0.07)',
    enemyZone: 'rgba(91, 253, 214, 0.08)',
    boundary: 'rgba(255, 156, 82, 0.37)',
    grid: 'rgba(77, 212, 255, 0.19)',
    overlay: '#0C1A29',
    flow: '#34E6FF',
    pulse: '#7BFFD7',
  ...
  vectorSpindle: {
    ...
    glowColor: '#D9C5FF',
    base: '#040812',
    auraA: 'rgba(177, 124, 255, 0.13)',
    auraB: 'rgba(45, 205, 255, 0.09)',
    enemyZone: 'rgba(169, 120, 255, 0.10)',
    boundary: 'rgba(255, 159, 83, 0.38)',
    grid: 'rgba(110, 133, 255, 0.21)',
    overlay: '#130C31',
    flow: '#6FD7FF',
    pulse: '#C17DFF',
